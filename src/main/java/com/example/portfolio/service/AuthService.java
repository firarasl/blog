...
import com.example.portfolio.model.VerificationToken;
import com.example.portfolio.repository.UserRepository;
import com.example.portfolio.repository.VerificationTokenRepository;
import com.example.portfolio.security.JwtProvider;
...
public class AuthService {
    ...
    private void fetchUserAndEnable(VerificationToken verificationToken) {
        ...
        User user = userRepository.findByUsername(username).orElseThrow(() -> new FiteNotFoundException("User not found with name - " + username));
    ...
    public void verifyAccount(String token) {
        ...
        fetchUserAndEnable(verificationToken.orElseThrow(() -> new FiteNotFoundException("Invalid Token")));
    }
